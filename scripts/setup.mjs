...
async function setup() {
  console.log("WristClaw Bridge setup wizard");
  console.log("");
...
function serializeEnv(values) {
  const lines = [
    "# Generated by WristClaw Bridge setup.",
...
function buildPairing(values) {
  ...
  return {
    ...payload,
    deepLink: `wristclaw://pair?payload=${base64UrlJson(payload)}`,
  };
}
...
<body>
  <main>
    ...
    <section class="card" aria-label="Pairing code">
      <img class="qr" src="./pairing-qr.svg" alt="WristClaw pairing QR code">
...
function printSetup(values) {
  ...
  console.log("");
  console.log("WristClaw Bridge configured");
